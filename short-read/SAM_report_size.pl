...
for my $file ( @ARGV ) {
    ...
    print $R "barplot(t(size5),xlab=\"Read Length\", ylab=\"Total # Reads\", main=\"Reads mapped by size - 5' base\",space=0.1,cex.axis=0.8,las=1,cex=0.8,legend=T,col=rainbow(5,start=.1, end=.91),beside=F)\n";
